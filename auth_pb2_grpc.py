...
class AuthServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Auth = channel.unary_unary(
                '/AuthService/Auth',
                request_serializer=auth__pb2.RequestAuth.SerializeToString,
...
def add_AuthServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Auth': grpc.unary_unary_rpc_method_handler(
                    servicer.Auth,
                    request_deserializer=auth__pb2.RequestAuth.FromString,
...
class AuthService(object):
    ...
    def Auth(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/AuthService/Auth',
            auth__pb2.RequestAuth.SerializeToString,
